...
IMAGES_CACHE_DIR = "Data/zara"
os.makedirs(IMAGES_CACHE_DIR, exist_ok=True)

# Path to your CSV and static images directory
csv_path = 'Data/store_zara.csv'
...
# Use the correct column name for image URLs
image_column = 'primary_image' if 'primary_image' in df.columns else 'images'
...
# Example test data
test_product_url = "https://www.zara.com/us/en/faux-leather-puffer-jacket-p08281420.html"
test_image_title = "a54505fa-d2ba-4268-904e-09dff1abe5d9.jpg"

# Modify the function call
result = download_and_cache_image(None, test_product_url)

# Add logging
print(f"Product URL: {test_product_url}")
print(f"Image Title: {test_image_title}")
print(f"Local Image Path: {os.path.join(IMAGES_CACHE_DIR, test_image_title)}")
